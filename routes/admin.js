  ...
  async (req, res) => {
    try {
      ...
      await medicine.update({
        ...
        generic_name: req.body.generic_name || null,
      ...
      req.flash("success_msg", "Medicine updated successfully");
      res.redirect("/admin/medicines");
    } catch (error) {
      console.error("Update medicine error:", error);
      req.flash("error_msg", "Error updating medicine");
      res.redirect("/admin/medicines");
    }
  },
);
